...
python seg_buildings_with_colour.py """write_data_to_tfrecords('${point_loc}', '${data_split}test_points.0.txt', '${dest_loc}test_no_colour_no_rot.tfrecords', 'data','${label_loc}','${colour_loc}',False)""" >> ${logfile}
python seg_buildings_with_colour.py """write_data_to_tfrecords('${point_loc}', '${data_split}val_points.shuffle.0.txt', '${dest_loc}val_no_colour_no_rot.tfrecords', 'data','${label_loc}','${colour_loc}',False)""" >> ${logfile}
python seg_buildings_with_colour.py """write_data_to_tfrecords('${point_loc}', '${data_split}train_points.shuffle.0.txt', '${dest_loc}train_no_colour_12_rot.0.tfrecords', 'data','${label_loc}','${colour_loc}',False)""" >> ${logfile}

cat ${dest_loc}train_no_colour_12_rot.0.tfrecords > ${dest_loc}train_no_colour_12_rot.shuffle.all.tfrecords

for i in `seq 1 38`;
  do
    python seg_buildings_with_colour.py """write_data_to_tfrecords('${point_loc}', '${data_split}train_points.shuffle.${i}.txt', '${dest_loc}train_no_colour_12_rot.${i}.tfrecords', 'data','${label_loc}','${colour_loc}',False)""" >> ${logfile}
	cat ${dest_loc}train_no_colour_12_rot.${i}.tfrecords >> ${dest_loc}train_no_colour_12_rot.shuffle.all.tfrecords      
  done

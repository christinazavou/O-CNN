...
#         train_summary_op = summary_dao.summary_op_for_train({'cost': cost, 'l2reg': l2reg, 'loss': loss})
#         test_summary_op, test_summary_placeholders = summary_dao \
#             .summary_op_for_test(['cost', 'l2reg', 'loss'])
#

...
def config_points_6(category="Bottle"):
...
def check_properties():
    ...
    with tf.Session() as sess:
        ...
        for cat_idx in range(len(categories)):
            ...
            octrees, filename, depth, task = config_points_6(categories[cat_idx])
            ...
            for i in range(take[cat_idx]):
                pl, xyz = sess.run([points_label, points_xyz])
